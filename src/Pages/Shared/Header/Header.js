    ...
    return (
        <div>
            ...
            <Navbar className='container bg-white' collapseOnSelect expand="lg" bg="light" variant="light">
                <Container>
                    <Navbar.Brand className='border border-success' href="#home">
                    ...
                    <Navbar.Collapse id="responsive-navbar-nav">
                        ...
                        <Nav className="me-auto border border-secondary">
                        ...
                        <Nav>
...

                            {
                                user?.uid
                                    ?
                                    <div className='d-flex flex-column flex-md-row border border-secondary align-items-center jusify-content-between'>
